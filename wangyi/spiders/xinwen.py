...
class XinwenSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        li_list = response.xpath('//*[@id="index2016_wrap"]/div[1]/div[2]/div[2]/div[2]/div[2]/div/ul/li')       # /html/body/div/div[3]/div[2]/div[2]/div/ul      /div[@class="list"]/ul/li
        print(li_list, "???")
        alist = [3, 4, 6, 7, 8]         # 国内，国际，军事，航空，无人机
        for index in alist:
